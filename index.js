const { TelegramBot, Collection } = require('telegramsjs');
...
bot.db = new CreateStorage({
  ...
  table: ["click", "command_blacklist", "cooldown", "currency", "global", "language", "main", "quest",  "shop", "supergroup",  "system", "username"]
})
